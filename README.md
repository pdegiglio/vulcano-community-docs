...
### 🎨 For Designers
- **[Theme System Overview](docs/theme/README.md)** - Understanding the theme architecture
- **[Designer Schema](docs/theme/designer-schema.md)** - Complete theme token reference for design handoff
- **[Color System](docs/theme/designer-schema.md#-color-system)** - Brand colors, states, and usage guidelines

### 💻 For Developers
- **[Developer Guide](docs/theme/developer-guide.md)** - How to use theme tokens in code
- **[Migration Status](docs/theme/migration-status.md)** - Current implementation progress
- **[Contributing Guidelines](docs/contributing/README.md)** - How to contribute

### 🔒 Security
- **[Security Overview](docs/security/README.md)** - Security practices and reporting
...
We welcome contributions! Please read our [Contributing Guidelines](docs/contributing/README.md) to get started.
...
- **Security Reports**: See [Security Policy](docs/security/README.md)
