...
1. **Review Current Theme**
   - Check [designer-schema.md](../theme/designer-schema.md)
...
1. **Using Theme Tokens**
   ...
   - Follow patterns in [developer-guide.md](../theme/developer-guide.md)
...
- **Design Questions**: Open an issue with the `design` label
